    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="md:ml-64 pb-20 md:pb-0">
        ...
        <header className="md:hidden bg-white border-b border-gray-200 px-4 py-4">
          <h1 className="text-lg font-semibold text-gray-900">Report Found Item</h1>
        </header>

        {/* Desktop header */}
        <header className="hidden md:flex items-center justify-between px-8 py-4 border-b border-gray-200 bg-white">
          <h1 className="text-xl font-semibold text-gray-900">Report Found Item</h1>
        </header>
          ...
          <div className="max-w-2xl">
            {success ? (
              <div className="bg-green-50 border border-green-200 rounded-2xl p-8 text-center">
                ...
                <p className="text-gray-600">Your found item report has been submitted successfully. The owner will be notified if there&apos;s a match.</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {/* Location Found */}
                <div>
                  <label htmlFor="locationFound" className="block text-sm font-medium text-gray-700 mb-2">
                    Location Found *
                  </label>
                  <input
                    type="text"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label htmlFor="timeFound" className="block text-sm font-medium text-gray-700 mb-2">
                      Time Found
                    </label>
                    <input
                      type="time"
                      ...
                      onChange={(e) => updateField("timeFound", e.target.value)}
                      className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all"
                    />
                  </div>
                </div>
